...
const personName = "Your message should be simple, such as, “Hello Hussnain, would you like to learn some Typescript today?";
...
let modeOfTransportations = ['bike', 'car', "Train", 'Bus', 'Rickshaw', 'Cycle'];
...
const guestList = ['Ahmad', 'Ali', "Raza", 'Usman', 'Ahsan'];
...
const guestList1 = ['Ahmad', 'Ali', "Raza", 'Usman', 'Ahsan'];
...
const favorite_fruits = ['apple', 'banana', 'mango']; // Change the fruits as per your favorites.
...
const currentUsers = ['john', 'jane', 'bobby', 'mary', 'david'];
...
const Pizzas = ['Margherita', 'Pepperoni', 'BBQ Chicken'];
...
const make_album = (artist, title, track) => {
...
const Magicians = ['magician1', 'magician2', 'magician3', 'magician4', 'magician5'];
show_magicians(Magicians);
//42 Great Magicians: Start with a copy of your program from Exercise 39.
//  Write a function called make_great() that modifies the array of magicians by adding the phrase the Great to each magician’s name.
//   Call show_magicians() to see that the list has actually been modified.
console.log("Exersice 42");
...
console.log("Exersice 43");
const make_great1 = (magician) => {
